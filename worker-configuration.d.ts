...
// Runtime types generated with workerd@1.20250705.0 2025-07-08 experimental,nodejs_compat
...
interface DurableObjectFacets {
    get(name: string, getStartupOptions: () => DurableObjectFacetsStartupOptions | Promise<DurableObjectFacetsStartupOptions>): Fetcher;
